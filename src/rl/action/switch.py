...
class SwitchAction(BaseAction):
    """Represents an action to switch an element in the network to a desired state."""
    ...
    def original_status(self):
        """Used to store the status of the element before getting switched."""
    ...
    def from_network(
        ...
        """Build action instance from network, allows some validation at instanciation."""
    ...
    def execute(self, network: Network) -> Network:
        """Executes the switch action on the network."""
